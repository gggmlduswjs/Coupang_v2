...
from dashboard.services.ad_service import (
    df_to_excel_bytes as _df_to_excel_bytes,
    style_excel_header as _style_excel_header,
    create_efficiency_excel as _create_efficiency_excel,
...
def _sync_performance(files, account_id):
    """광고 성과 보고서 동기화"""
    from scripts.sync.sync_ad_performance import AdPerformanceSync
...
def _sync_spend(files):
    """광고비 정산 보고서 동기화"""
    from scripts.sync.sync_ad_spend import AdSpendSync
